class ConfigLogger:
    def __init__(self, level: str,rotation:str,retention:str, format: str):
    ...
    def __repr__(self):
        return f"<日志配置信息(level={self.level},rotation={self.rotation}, retention={self.retention}, format={self.format})>"
        # 打印类的实例化对象会打印这里面的内容
